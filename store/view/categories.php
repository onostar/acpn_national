...
<meta name="description" content="ACPN is the National reguatory body for all pharmacist in Nigeria. it is formally known as Association of COmmunity Pharmacist of NIgeria">
    ...
    <title>
        <?php
            ...
            echo $view->first_name . " " . $view->last_name. " - Eko Akate 2022 |categories";
        ?>
    </title>
        ...
        <section id="searchResults">
            <?php
                if(isset($_POST['check_category'])){
                    ...
                    $search_query = $connectdb->prepare("SELECT * FROM menu WHERE item_category = :item_category ORDER BY item_name");
