<?php
    ...
    if(isset($_POST['update_profile'])){
        ...
        $update_profile = $connectdb->prepare("UPDATE shoppers SET first_name = :first_name, last_name = :last_name, phone_number = :phone_number, address = :address, city = :city, pharmacy = :pharmacy WHERE email = :email");
